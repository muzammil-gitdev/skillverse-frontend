        ...
        <section id="cta" className="py-16 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="relative overflow-hidden bg-[#1dbf73] rounded-[2.5rem] px-6 py-16 md:px-16 md:py-20 text-center shadow-2xl shadow-[#1dbf73]/20">
                    {/* Background Pattern/Decor - subtle circles */}
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 mt-8 border-t border-white/20">
                            <div className="space-y-1">
                                ...
                                <div className="text-sm font-medium text-green-100 uppercase tracking-wide">Active Freelancers</div>
                            </div>
                            <div className="space-y-1">
                                <div className="text-3xl font-bold text-white">500K+</div>
                                <div className="text-sm font-medium text-green-100 uppercase tracking-wide">Projects Completed</div>
                            </div>
                            <div className="space-y-1">
                                <div className="text-3xl font-bold text-white">$100M+</div>
                                <div className="text-sm font-medium text-green-100 uppercase tracking-wide">Paid to Freelancers</div>
                            </div>
                        </div>
                    </div>
                </div>
