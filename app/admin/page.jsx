      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm mt-8 min-h-[400px]">
        ...
        <div className="flex flex-col gap-4">
          <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-600 border border-gray-100">
            ...
            registered as a new Freelancer.{" "}
            <span className="text-xs text-gray-400 block mt-1">2 mins ago</span>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-600 border border-gray-100">
            <span className="font-semibold text-gray-900">TechCorp</span> posted
            a new job &quot;React Native Developer needed&quot;.{" "}
          ...
          <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-600 border border-gray-100">
            ...
            submitted a profile report.{" "}
            <span className="text-xs text-gray-400 block mt-1">1 hour ago</span>
          </div>
        </div>
      </div>
    </div>
