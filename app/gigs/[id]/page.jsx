                  ...
                  <button
                    onClick={() => {
                      ...
                      const query = new URLSearchParams({
                        packageIndex: activeTab,
                        packageName: currentPackage.title || activeTab,
                        packageDesc: gig.description,
                        packagePrice: currentPackage.price,
                        packageDelivery: currentPackage.deliveryTime,
                        packageRevisions: currentPackage.revisions,
                        // Ensure features are stringified so they can be passed in a URL
                        packageFeatures: JSON.stringify(
                      ...
                      // 2. Navigate with the query string
                      router.push(`/gigs/${gig._id}/order?${query.toString()}`);
                    }}
