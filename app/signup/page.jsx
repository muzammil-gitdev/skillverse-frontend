  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="w-full max-w-md mt-8 md:mt-0">
          ...
          <form className="space-y-6" onSubmit={handleNext}>
            ...
            <div className="flex items-center">
              <input id="terms" name="terms" type="checkbox" required className="h-4 w-4 text-[#1dbf73] focus:ring-[#1dbf73] border-gray-300 rounded cursor-pointer" />
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                I agree to the <a href="#" className="link-primary">Terms</a> and <a href="#" className="link-primary">Privacy Policy</a>
              </label>
            </div>
      ...
      <div className="hidden md:flex flex-col justify-center items-center bg-[#1dbf73] p-12 relative overflow-hidden order-1 md:order-2 group">
        <div className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1920&q=80")' }}></div>
        ...
        <div className="relative z-10 text-center text-white space-y-6 max-w-lg">
          ...
          <p className="text-lg text-green-50">Sign up and discover a vast world of opportunities!</p>
        </div>
      </div>
    </div>
  );
